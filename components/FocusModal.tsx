...
const FOCUS_MODAL_TEXT = {
  ...
  en: {
    ...
    keepGoing: "{text.keepGoing}",
    youDidIt: "{text.youDidIt}",
    ...
    <AnimatePresence mode="wait">
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
        ...
        <motion.div
          ...
          } max-h-[calc(100dvh-32px)] overflow-y-auto rounded-[42px] sm:rounded-[50px] p-6 sm:p-10 md:p-12 border border-white/10 text-center shadow-[0_30px_60px_rgba(0,0,0,0.5)] overflow-hidden`}
        >
          {!showCompliment && (
